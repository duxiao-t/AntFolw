  ...
  return (
    <AppPage title="提交成功" back={false} action={<button className="app-bar__action" type="button" onClick={() => navigate("/workbench")}>关闭</button>}>
      <div className="empty-hero" style={{ padding: "48px 16px 24px" }}>
        ...
        <div className="success-summary"><div><span className="muted">流水号</span><b>{businessNo}</b></div><div><span className="muted">当前状态</span><b style={{ color: "var(--af-color-primary)" }}>{direct ? "已完成" : "等待审批"}</b></div></div>

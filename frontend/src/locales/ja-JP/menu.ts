export default {
  ...
  'menu.admin.companies': '会社管理',
  'menu.admin.departments': '部門管理',
  'menu.admin.users': 'ユーザー管理',
  'menu.admin.forms': 'フォーム管理',
  'menu.admin.form-data': 'フォームデータ',
  'menu.admin.processes': 'プロセス管理',
  'menu.mySubmissions': '自分の申請',
  'menu.inbox': '受信タスク',
  'menu.done': '完了タスク',
  'menu.proc': '自分のプロセス',
  'menu.login': 'ログイン',

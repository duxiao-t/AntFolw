export default {
  ...
  'menu.admin.companies': 'Empresas',
  'menu.admin.departments': 'Departamentos',
  'menu.admin.users': 'Usuários',
  'menu.admin.forms': 'Formulários',
  'menu.admin.form-data': 'Dados de Formulário',
  'menu.admin.processes': 'Processos',
  'menu.mySubmissions': 'Minhas submissões',
  'menu.inbox': 'Caixa de entrada',
  'menu.done': 'Concluídas',
  'menu.proc': 'Meus processos',
  'menu.login': 'Login',
